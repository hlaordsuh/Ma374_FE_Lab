...
def func(string,string2,vall,vall2):
    ...
    mu_arr = np.linspace(-0.50,2.20,401)
    xx1 = []
    xx2 = []
    SD1_arr = []
    SD2_arr = []
...
#     plt.scatter(math.sqrt(val2),val,label="Index Portfolio")
    ...
    print("")
    print("The risk Free return = 0.05")
...
print("Variance for NIFTY is:",nse_var)

print("")
print("Expected return for SENSEX is:",bse_mean)
print("Variance for SENSEX is:",bse_var)
...
print("")
print("Considering 10 Stocks not included in BSE SENSEX")
func("nse_non_index_data1.csv","10 Stocks not in BSE SENSEX",bse_mean,bse_var)

print("")
print("Considering 10 Stocks not included in NSE NIFTY")
